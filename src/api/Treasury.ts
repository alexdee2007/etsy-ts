...
export class Treasury {
     ...
     */
    async findAllTreasuries(parameters: IFindAllTreasuriesParameters, options?: IAuthOptions) {
     ...
     * Get a Treasury
     */
    async getTreasury(parameters: IGetTreasuryParameters, options?: IAuthOptions) {
     ...
     * Delete a Treasury
     */
    async deleteTreasury(parameters: IDeleteTreasuryParameters, options?: IAuthOptions) {
     ...
     */
    async findAllUserTreasuries(parameters: IFindAllUserTreasuriesParameters, options?: IAuthOptions) {
